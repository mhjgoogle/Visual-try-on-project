...
| AI 生成分镜草稿（60 镜） | ✅ | ✅ | ✅ C-011 | 🟡 靠 Skill | — | KEEP | — |
| 分镜锁定为正式版本（Gateway） | ✅ | ✅ | ✅ | ❌ 无 | — | **KEEP** | — |
| 场景层实际使用 | ✅ | ✅ | 🔴 48 集全部 0 场景 0 归属 | n/a | Domain Model | 观察 | P3 |
| 景别/角度/**运镜**/动作/情绪 | ✅ 字段 | ✅ | 🔴 60 镜**全部「未记录」** | ✅ 运镜=可复用预设 | **Domain Model** | ADD | P2 |
...
| **整集拍平清单**（模型/时长/尺寸/首帧来源/失败态） | ✅ 数据齐 | ❌ | 🔴 **不存在**；审片是 60 个页码逐个翻，且 ⑨ 粗剪审片完全不可达 | ✅ **故事板**三列 + `成片/片段` 筛选 | **IA** | **ADD** | **P1** |
