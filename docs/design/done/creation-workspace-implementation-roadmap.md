...
> （TASK-024～033）全部在 `docs/tasks/`，WSM-F 的剩余部分由
> [TASK-040](../../tasks/TASK-040-final-unified-product-acceptance.md) 承接 ——
> 本文因此只作历史查阅（当时的里程碑切法与进入条件），**不再是待办来源**。
> 待办看 [STATUS.md](../../STATUS.md) 与 `docs/tasks/`（ADR-0087 决策 2）。
>
