...
- 状态：**Accepted**（2026-09-05，实施 Agent 依 AGENTS.md §1 自行 Accept —— 纯技术决策：登记点、依赖方向、合同测试形状。决策 1–3 已由 [TASK-127](../tasks/TASK-127-one-action-table.md) 实施并有合同测试；决策 4 待另一张卡）
