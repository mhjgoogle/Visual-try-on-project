...
> ADR-0038 已 Accepted，[TASK-035](TASK-035-wfm2-multimedia-generation-and-lineage.md)
> 与 [TASK-039](TASK-039-workspace-multimedia-and-full-workflow-expansion.md)
...
> 结论**。[TASK-083](TASK-083-phase3-adrs-first.md) §5.1 要求「顺带在文档里
> 明确它的去留」，[TASK-103](TASK-103-frontback-and-ui-residuals.md) 批次 B
