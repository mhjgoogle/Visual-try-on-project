...
- 状态：待办 · **里程碑闸 2026-09-18 判「现在不做」**：这是上一轮里程碑（短剧线统一验收）的
  里程碑卡，PASS 归产品负责人一句话；当前里程碑已换成 REQ-009「先把小说写出来」，本卡不在
  其交付面上、不阻塞它、无不可逆损害，也没有 Agent 在为它备证据。**什么条件下变成该做**：
  REQ-009 四个切片落地、小说接回剧集线之后，产品负责人要对整条线做最终验收时 ——
  那时按下面的逐条判词补证据。判词本身保留：
  **逐条判词见 §验收判词（2026-09-04 订正）。** 不再用一个总标题
