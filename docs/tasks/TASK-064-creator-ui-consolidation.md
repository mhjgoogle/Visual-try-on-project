...
- 状态：完成 · **已验收**（产品负责人 2026-08-13 随 ADR-0066 批准一并收口）
- 实施基线：`ae0a54a`
...
| 分配到 | 条数 | 条目 |
| --- | --- | --- |
| [TASK-072](TASK-072-system-contract-and-persistent-runs.md) §1.9 **批次三**（领域 / 前端） | **13**（同族合并为 10 行） | §4d 第 1 / 2 / 3 / 4 / 5 条 · §4f · §4g 第 1 / 2 条 · §4i 第 2 条 · §4j（未复现）· §4k 第 2 条 · §4l · §4m |
| [TASK-074](TASK-074-delivery-migration-and-legacy-retirement.md) §1.1b（`mix-shot` 端点） | **4** | §4h 第 1 / 2 条 · §4i 第 1 条 · §4k 第 1 条 |
