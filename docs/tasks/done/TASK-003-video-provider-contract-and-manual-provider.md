...
3. 创建正式设计文档 `docs/design/done/TASK-003-provider-contract-design.md`
   （已创建，内容要求见"预实施设计文档要求"）；
...
10. 编码前的正式设计文档
    `docs/design/done/TASK-003-provider-contract-design.md`（编码门槛第 3 项，
    本轮不创建）；
...
- `docs/design/done/TASK-003-provider-contract-design.md`（编码前交付，
  本轮不创建）；
...
编码前必须创建 `docs/design/done/TASK-003-provider-contract-design.md` 并通过
...
1. VideoProvider 精确接口有明确文档和类型契约，且与通过审查的设计文档
   `docs/design/done/TASK-003-provider-contract-design.md` 一致；
...
- 新增（编码前）：`docs/design/done/TASK-003-provider-contract-design.md`
...
- 第二轮窄范围复审：唯一剩余问题为 `observed_at` 与 `completed_at` 的
  ...
  （`0e581d1`）；
- 设计文档审查：`docs/design/done/TASK-003-provider-contract-design.md`
...
- approved design document:
  docs/design/done/TASK-003-provider-contract-design.md
