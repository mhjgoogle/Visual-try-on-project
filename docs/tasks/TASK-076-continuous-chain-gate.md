...
- 状态：完成 · **已完成** —— ~~已实施，待 Codex 复审~~（2026-08-23 订正）。`c1edb00` 的跨模型
  补审已于 2026-08-16 完成（补审批次 G「链令牌与冲突扫描」，报 7 条 → 3 真已修
  + 1 驳回 + 3 条转「仍然待办」，那 3 条此后也全部闭合，见
  [待复审清单](../design/active/pending-codex-rereview.md)）
...
本卡已登记到 [待 Codex 复审清单](../design/active/pending-codex-rereview.md)，
