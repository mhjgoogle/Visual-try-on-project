...
**当前**：10 在办 · 8 待办 · 130 已完成 · 89 条 ADR。
...
| [TASK-149-task-prerequisites-are-machine-readable.md](tasks/TASK-149-task-prerequisites-are-machine-readable.md) | TASK-149：卡上的「前置」变成机器读得到的边，队列按它排 | 进行中 |
| [TASK-150-task-state-on-the-card.md](tasks/TASK-150-task-state-on-the-card.md) | TASK-150：任务的状态住在卡上 —— 目录平铺，「在办的有哪些」由工具回答 | 进行中 |
